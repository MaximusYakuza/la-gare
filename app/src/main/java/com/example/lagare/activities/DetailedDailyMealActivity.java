...
public class DetailedDailyMealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ✅ Pasamos el contexto al adapter para que funcione el botón Agregar al Carrito
        ...
        } else if (type != null && type.equalsIgnoreCase("almuerzo")) {
        ...
        } else if (type != null && type.equalsIgnoreCase("cena")) {
        ...
        } else if (type != null && type.equalsIgnoreCase("dulces")) {
        ...
        } else if (type != null && type.equalsIgnoreCase("cafe")) {
